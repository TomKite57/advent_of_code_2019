...
class int_code:
    ...
    def run(self):
        ...
        while(0 <= index < len(self.code)):
            ...
            if (run_code == "01"):
                param1 = self.code[index+3]
                param2 = self.code[index+1]
                param3 = self.code[index+2]
...
input_file = genfromtxt(file_name, dtype=int, delimiter=",")

my_int_code = int_code(input_file, 1)
